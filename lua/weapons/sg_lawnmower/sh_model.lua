...
SWEP.VElements = {
	["ammo display quad"] = { type = "Quad", bone = "ValveBiped.Bip01", rel = "screen", pos = Vector(1.349, -0.22, 0.1), angle = Angle(0, 90, 90), size = 0.005, draw_func = "DrawAmmoCounter" },
	["screen fake"] = { type = "Model", model = "models/hunter/plates/plate025x025.mdl", bone = "ValveBiped.Gun", rel = "top", pos = Vector(1.14, 0.5, -0.1), angle = Angle(90, 180, 0), size = Vector(0.05, 0.1, 0.01), color = Color(120, 140, 90, 255), surpresslightning = false, bonemerge = false, highrender = false, nocull = false, material = "model_color", skin = 0, bodygroup = {} },
	["littlescreen display"] = { type = "Quad", bone = "ValveBiped.Bip01_Spine4", rel = "top", pos = Vector(1.175, -0.535, -0.08), angle = Angle(0, 90, 90), size = 0.002, draw_func = "DrawReserveCounter"},
	...
	["screen"] = { type = "Model", model = "models/props_lab/monitor01b.mdl", bone = "ValveBiped.Gun", rel = "body", pos = Vector(-0.465, -2.57, 4.186), angle = Angle(50, 0, 180), size = Vector(0.213, 0.213, 0.213), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, nocull = false, material = "", skin = 0, bodygroup = {} },
...
SWEP.WElements = {
	...
	["screen"] = { type = "Model", model = "models/props_lab/monitor01b.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "body", pos = Vector(-0.465, -2.57, 4.186), angle = Angle(50, 0, 180), size = Vector(0.213, 0.213, 0.213), color = Color(255, 255, 255, 255), surpresslightning = false, bonemerge = false, highrender = false, nocull = false, material = "", skin = 0, bodygroup = {} },
