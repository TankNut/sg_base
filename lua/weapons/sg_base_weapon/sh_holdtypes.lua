...
addHoldType("heavy", "ar2")

holdtypes.heavy[ACT_MP_ATTACK_STAND_PRIMARYFIRE] = ACT_HL2MP_GESTURE_RANGE_ATTACK_PHYSGUN
holdtypes.heavy[ACT_MP_ATTACK_CROUCH_PRIMARYFIRE] = ACT_HL2MP_GESTURE_RANGE_ATTACK_PHYSGUN

addHoldType("sniper", "ar2")

holdtypes.sniper[ACT_MP_STAND_IDLE] = ACT_HL2MP_IDLE_RPG
holdtypes.sniper[ACT_MP_WALK] = ACT_HL2MP_WALK_RPG
holdtypes.sniper[ACT_MP_RUN] = ACT_HL2MP_RUN_RPG
-- holdtypes.sniper[ACT_MP_CROUCH_IDLE] = ACT_HL2MP_IDLE_CROUCH_RPG
-- holdtypes.sniper[ACT_MP_CROUCHWALK] = ACT_HL2MP_WALK_CROUCH_RPG
